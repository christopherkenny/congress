...
Kenny C (2026). *congress: Access the Congress.gov API*. R package
version 0.1.1, <https://github.com/christopherkenny/congress>.

    @Manual{,
      title = {congress: Access the Congress.gov API},
